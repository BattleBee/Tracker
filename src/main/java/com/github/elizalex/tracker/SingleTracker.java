 ...
 *
 *Так как нам нужно чтобы класс мог реализовывать все методы от класса MemTracker,
 * воспользовались композицией объектов чтобы не копировать код из класса MemTracker.
 *
 */
